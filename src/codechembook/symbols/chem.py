...
Angstrom: str = '\u212B'  # Ångström symbol
wavenumber: str = 'cm\u207B\u00B9'  # inverse centimeters (wavenumber)
...
rxn_arrow_right: str = '\u2192'  # right-pointing reaction arrow
rxn_arrow_left: str = '\u2190'  # left-pointing reaction arrow
equil_arrow: str = '\u21CC'  # equilibrium arrow (right harpoon over left harpoon)
resonance_arrow: str = '\u2194'  # resonance arrow (left-right arrow)
